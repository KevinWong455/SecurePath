...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SecurePath processing");
    
    let mut processor = SecurePathProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SecurePathProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SecurePathProcessor::new(false);
